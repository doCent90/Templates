...
namespace Destructible2D
{
	...
	public class D2dDestructibleSprite : D2dDestructible
	{
		...
		[SerializeField] private SpriteRenderer downLayerSprite;
        ...
        protected virtual void Start()
		{
            ...
            if(AlphaCount == OriginalAlphaCount && downLayerSprite != null)
            {
                downLayerSprite.enabled = false;
            }
